...
public class AngleSpriteLayout
{
	...
	public void fillVertexValues(int frame, FloatBuffer vertexValues)
	{
		if (frame<roFrameCount)
		{
			vertexValues.put(0,-mPivot[frame].mX);
			vertexValues.put(1,roHeight - mPivot[frame].mY);
			vertexValues.put(2,roWidth - mPivot[frame].mX);
			vertexValues.put(3,roHeight - mPivot[frame].mY);
			vertexValues.put(4,-mPivot[frame].mX);
			vertexValues.put(5,-mPivot[frame].mY);
			vertexValues.put(6,roWidth - mPivot[frame].mX);
			vertexValues.put(7,-mPivot[frame].mY);
		}
	}
